...
ignore: unrelated background small talk, filler, background conversation, acknowledgements that need no continuation, someone speaking their own answer, or reading/echoing the assistant's current response without a new request. A bare yes can be answer or ignore depending on the preceding conversation.
