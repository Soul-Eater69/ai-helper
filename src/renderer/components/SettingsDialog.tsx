    ...
    >
      ...
      <div className="dialog-body">
        ...
        <section>
          ...
          />
          <label htmlFor="profile">Your background and experience</label>
          <textarea
            id="profile"
            value={draft.profile}
            maxLength={20000}
        ...
        <section>
          <h3>Story bank</h3>
          <p>
            Add real experiences in STAR format. Relevant questions receive up to two matching
            stories, alongside your background. Follow-up questions can reuse their facts.
          </p>
            ...
            <div className="story-card" key={item.id}>
              ...
              {(
                ...
                <textarea
                  ...
                  maxLength={
                    { situation: 4000, task: 2000, action: 6000, result: 3000, learning: 2000 }[
                      field
                    ]
                  }
                  value={item[field]}
