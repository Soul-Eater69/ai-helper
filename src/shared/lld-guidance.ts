...
Ask one clarifying question at a time, in the language of the user's action or expected result. A concrete situation or a short contrast can expose the decision better than a vague question about requirements. Briefly explain why you need to know only when that makes the question clearer; do not add a lecture or forced filler. Do not ask the interviewer to choose your classes, patterns or data structures. Related details can belong to one decision, but do not bundle unrelated decisions that an answer like yes cannot resolve.
